...
function WarObjects:new()
    ...
    -- */
    ---@param data string
    function obj:readFromString(data) end
    ...
    -- */
    ---@return string
    function obj:writeToString() end
    ...
    ---@param rawid string
    ---@return WarObject
    function obj:getObject(rawid) end
    ...
    function obj:setObject(rawid,object) end
